...
flowchart TD
    ...
    style P1 fill:#e8f4ea
    style P2 fill:#dceefb
    style P3 fill:#fff3cd
    style P4 fill:#fde2e2
    style P5 fill:#ece0f8
```
...
```mermaid
flowchart TD
    subgraph Foundation["Foundation (R20-R23)"]
        A1[Know where\nyou stand\nR20] --> A2[Make a plan\nR21] --> A3[Control your\nfinances\nR22]
    end
    subgraph Behavior["Behavior & Discipline (R32-R46)"]
        B1[Work hard\nR32] --> B2[Spend less\nthan you earn\nR40] --> B3[Avoid debt /\npay it off\nR41,R44]
    end
    subgraph Growth["Growth & Investing (R47-R69)"]
        C1[Build capital\nR49] --> C2[Invest what\nyou understand\nR56] --> C3[Think long term,\navoid fiddling\nR60,R61]
    end
    Foundation --> Behavior --> Growth
```
...
```mermaid
flowchart LR
    A[Use wealth\nwisely R96] --> B[Give as equity,\nnot loans\nR97-98]
    B --> C[Accept you\ncan't take it\nwith you R99]
    C --> D[Learn to say\nno gracefully\nR100]
    D --> E[Give without\ncreating debt-\nfeelings R101]
    E --> F[Don't over-\nprotect kids\nR102]
    F --> G[Choose charities\ncarefully R103]
    G --> H[Stay humble,\ndon't flaunt it\nR106]
```
...
flowchart TB
    ...
    P1 --> R1["R1: Anyone Can\nBe Wealthy (hub)"]
    P1 --> R2[R2: Define Wealth]
    P1 --> R7[R7: Money Beliefs]
    P1 --> R8[R8: Consequence\nnot Reward]
    P1 --> R19["R19: Self-Mastery\n(feeds into all parts)"]
 
    P2 --> R20["R20: Know Where\nYou Are (hub)"]
    P2 --> R21[R21: Have a Plan]
    P2 --> R22[R22: Control\nFinances]
    P2 --> R40[R40: Spend Less\nThan You Earn]
    P2 --> R56[R56: Understand\nWhat You Buy]
 
    P3 --> R71["R71: Get Money\nMentors (hub)"]
    P3 --> R76[R76: Spot Hidden\nOpportunity]
    P3 --> R86[R86: Avoid\nHerd Behavior]
 
    P4 --> R91["R91: Contingency\nFund (hub)"]
    P4 --> R93[R93: Never Lend\nto Family]
    P4 --> R95[R95: Know When\nto Stop]
 
    P5 --> R96["R96: Use Wealth\nWisely (hub)"]
    P5 --> R101[R101: Give\nWithout Debt]
    P5 --> R106[R106: Don't\nFlaunt It]
